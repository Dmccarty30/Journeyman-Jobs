...
class _UnionsWidgetState extends State<UnionsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnionsModel());
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      StreamBuilder<List<LocalsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<LocalsRecord> listViewLocalsRecordList =
                              snapshot.data!;
                          ...
                          return ListView.separated(
                            ...
                            itemCount: listViewLocalsRecordList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 10.0),
                            itemBuilder: (context, listViewIndex) {
                              final listViewLocalsRecord =
                                  listViewLocalsRecordList[listViewIndex];
                              return Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                                  color: Color(0x19666666),
