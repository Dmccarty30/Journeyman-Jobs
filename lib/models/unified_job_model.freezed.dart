...
mixin _$UnifiedJobModel {
 ...
 String get id;@JsonKey(includeToJson: false, includeFromJson: false) DocumentReference? get reference; String get sharerId; Map<String, dynamic> get jobDetails; bool get matchesCriteria; bool get deleted; int? get local; String? get classification; String get company; String get location;@JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson) GeoPoint? get geoPoint; int? get hours; double? get wage; String? get sub; String? get jobClass; int? get localNumber; String? get qualifications; String? get datePosted; String? get jobDescription; String? get jobTitle; String? get perDiem; String? get agreement; String? get numberOfJobs;@JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson) DateTime? get timestamp; String? get startDate; String? get startTime; List<int>? get booksYourOn; String? get typeOfWork; String? get duration; String? get voltageLevel; List<String>? get certifications; bool get isSaved; bool get isApplied;
...
@useResult
$Res call({
 String id,@JsonKey(includeToJson: false, includeFromJson: false) DocumentReference? reference, String sharerId, Map<String, dynamic> jobDetails, bool matchesCriteria, bool deleted, int? local, String? classification, String company, String location,@JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson) GeoPoint? geoPoint, int? hours, double? wage, String? sub, String? jobClass, int? localNumber, String? qualifications, String? datePosted, String? jobDescription, String? jobTitle, String? perDiem, String? agreement, String? numberOfJobs,@JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson) DateTime? timestamp, String? startDate, String? startTime, List<int>? booksYourOn, String? typeOfWork, String? duration, String? voltageLevel, List<String>? certifications, bool isSaved, bool isApplied
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(includeToJson: false, includeFromJson: false)  DocumentReference? reference,  String sharerId,  Map<String, dynamic> jobDetails,  bool matchesCriteria,  bool deleted,  int? local,  String? classification,  String company,  String location, @JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson)  GeoPoint? geoPoint,  int? hours,  double? wage,  String? sub,  String? jobClass,  int? localNumber,  String? qualifications,  String? datePosted,  String? jobDescription,  String? jobTitle,  String? perDiem,  String? agreement,  String? numberOfJobs, @JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson)  DateTime? timestamp,  String? startDate,  String? startTime,  List<int>? booksYourOn,  String? typeOfWork,  String? duration,  String? voltageLevel,  List<String>? certifications,  bool isSaved,  bool isApplied)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnifiedJobModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(includeToJson: false, includeFromJson: false)  DocumentReference? reference,  String sharerId,  Map<String, dynamic> jobDetails,  bool matchesCriteria,  bool deleted,  int? local,  String? classification,  String company,  String location, @JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson)  GeoPoint? geoPoint,  int? hours,  double? wage,  String? sub,  String? jobClass,  int? localNumber,  String? qualifications,  String? datePosted,  String? jobDescription,  String? jobTitle,  String? perDiem,  String? agreement,  String? numberOfJobs, @JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson)  DateTime? timestamp,  String? startDate,  String? startTime,  List<int>? booksYourOn,  String? typeOfWork,  String? duration,  String? voltageLevel,  List<String>? certifications,  bool isSaved,  bool isApplied)  $default,) {final _that = this;
switch (_that) {
case _UnifiedJobModel():
return $default(_that.id,_that.reference,_that.sharerId,_that.jobDetails,_that.matchesCriteria,_that.deleted,_that.local,_that.classification,_that.company,_that.location,_that.geoPoint,_that.hours,_that.wage,_that.sub,_that.jobClass,_that.localNumber,_that.qualifications,_that.datePosted,_that.jobDescription,_that.jobTitle,_that.perDiem,_that.agreement,_that.numberOfJobs,_that.timestamp,_that.startDate,_that.startTime,_that.booksYourOn,_that.typeOfWork,_that.duration,_that.voltageLevel,_that.certifications,_that.isSaved,_that.isApplied);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(includeToJson: false, includeFromJson: false)  DocumentReference? reference,  String sharerId,  Map<String, dynamic> jobDetails,  bool matchesCriteria,  bool deleted,  int? local,  String? classification,  String company,  String location, @JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson)  GeoPoint? geoPoint,  int? hours,  double? wage,  String? sub,  String? jobClass,  int? localNumber,  String? qualifications,  String? datePosted,  String? jobDescription,  String? jobTitle,  String? perDiem,  String? agreement,  String? numberOfJobs, @JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson)  DateTime? timestamp,  String? startDate,  String? startTime,  List<int>? booksYourOn,  String? typeOfWork,  String? duration,  String? voltageLevel,  List<String>? certifications,  bool isSaved,  bool isApplied)?  $default,) {final _that = this;
switch (_that) {
case _UnifiedJobModel() when $default != null:
return $default(_that.id,_that.reference,_that.sharerId,_that.jobDetails,_that.matchesCriteria,_that.deleted,_that.local,_that.classification,_that.company,_that.location,_that.geoPoint,_that.hours,_that.wage,_that.sub,_that.jobClass,_that.localNumber,_that.qualifications,_that.datePosted,_that.jobDescription,_that.jobTitle,_that.perDiem,_that.agreement,_that.numberOfJobs,_that.timestamp,_that.startDate,_that.startTime,_that.booksYourOn,_that.typeOfWork,_that.duration,_that.voltageLevel,_that.certifications,_that.isSaved,_that.isApplied);case _:
  return null;
...
class _UnifiedJobModel extends UnifiedJobModel {
  const _UnifiedJobModel({required this.id, @JsonKey(includeToJson: false, includeFromJson: false) this.reference, this.sharerId = '', final  Map<String, dynamic> jobDetails = const {}, this.matchesCriteria = false, this.deleted = false, this.local, this.classification, required this.company, required this.location, @JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson) this.geoPoint, this.hours, this.wage, this.sub, this.jobClass, this.localNumber, this.qualifications, this.datePosted, this.jobDescription, this.jobTitle, this.perDiem, this.agreement, this.numberOfJobs, @JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson) this.timestamp, this.startDate, this.startTime, final  List<int>? booksYourOn, this.typeOfWork, this.duration, this.voltageLevel, final  List<String>? certifications, this.isSaved = false, this.isApplied = false}): _jobDetails = jobDetails,_booksYourOn = booksYourOn,_certifications = certifications,super._();
  factory _UnifiedJobModel.fromJson(Map<String, dynamic> json) => _$UnifiedJobModelFromJson(json);

@override final  String id;
@override@JsonKey(includeToJson: false, includeFromJson: false) final  DocumentReference? reference;
...
@override@JsonKey(toJson: _geoPointToJson, fromJson: _geoPointFromJson) final  GeoPoint? geoPoint;
...
@override@JsonKey(toJson: _timestampToJson, fromJson: _timestampFromJson) final  DateTime? timestamp;
