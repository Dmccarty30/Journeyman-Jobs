...
class TailboardComponents {
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: isPressed
            ? BoxDecoration(
                color: TailboardTheme.surfaceHigh,
                borderRadius: TailboardTheme.radiusLarge,
                boxShadow: TailboardTheme.elevation1,
              )
            : isHovered
              ? TailboardTheme.cardHoverDecoration
              : TailboardTheme.cardDecoration,
          child: Padding(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        location,
                        style: TailboardTheme.bodyLarge,
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      wage,
                      style: TailboardTheme.accentText,
                    ),
                  ],
                ),
              ],
  ...
  static Widget _statusBadge(BuildContext context, String status) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: TailboardTheme.getStatusGradient(status),
  ...
  static Widget circuitBackground(BuildContext context, {
    ...
    return Container(
      decoration: showCircuit
        ? BoxDecoration(
            gradient: TailboardTheme.primaryBackground,
          )
        : BoxDecoration(
            color: TailboardTheme.background,
          ),
      child: Stack(
        children: [
          if (showCircuit)
  ...
  static Widget simplifiedHeader(BuildContext context, {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: TailboardTheme.elevation3,
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  static Widget optimizedTabBar(BuildContext context, {
    ...
    return Container(
      ...
      child: TabBar(
        ...
        labelColor: TailboardTheme.copper600,
        unselectedLabelColor: TailboardTheme.navy600,
        labelStyle: TailboardTheme.bodyMedium.copyWith(fontWeight: FontWeight.w600),
        unselectedLabelStyle: TailboardTheme.bodyMedium,
                  ...
                  ? SizedBox(
                      ...
                      child: CircularProgressIndicator(
                        ...
                        valueColor: AlwaysStoppedAnimation<Color>(
                          TailboardTheme.getButtonTextStyle(isPrimary, true).color!,
                        ),
                      ),
                    )
                  : Row(
                      ...
                      children: [
                        if (icon != null) ...[
                          Icon(
                            icon,
                            size: 18,
                            color: TailboardTheme.getButtonTextStyle(isPrimary, true).color,
                          ),
                          const SizedBox(width: TailboardTheme.spacingXs),
                        ],
                        Text(
                          text,
                          style: TailboardTheme.getButtonTextStyle(isPrimary, true),
                        ),
                      ],
                    ),
              ),
  ...
  static Widget glassCard(BuildContext context, {
    ...
    return Container(
      width: width,
      height: height,
      decoration: TailboardTheme.glassDecoration,
      child: child,
    );
  }
  ...
  static Widget glowContainer(BuildContext context, {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        borderRadius: TailboardTheme.radiusMedium,
        boxShadow: isActive
          ? TailboardTheme.electricalGlowShadow
          : TailboardTheme.elevation1,
      ),
      child: Container(
        decoration: BoxDecoration(
          borderRadius: TailboardTheme.radiusMedium,
          gradient: isActive
            ? TailboardTheme.electricalGlow
            : null,
        ),
        child: child,
      ),
...
class AdaptiveCircuitPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = TailboardTheme.circuitGlow;
    paint.strokeWidth = 1;
