...
String _$userCrewsStreamHash() => r'2b903c0369110ff721d5dce1a146cd968ec4f0b2';
...
String _$isUserInCrewHash() => r'790b6c175e8b4b48892969dbd1c2e809f3767cf3';
...
String _$currentUserCrewMemberHash() =>
    r'09f7be32fb71c3926cfe6f06db699cfa8c46483e';
...
String _$canCreateCrewsHash() => r'bf9f0da9fd3d2108ca410045521833a1da7444af';
...
const pendingInvitationsProvider = PendingInvitationsProvider._();
...
final class PendingInvitationsProvider
    extends
        $FunctionalProvider<
          ...
          List<CrewInvitation>
        >
    with $Provider<List<CrewInvitation>> {
  /// Provider for pending crew invitations (invitations received by current user)
  const PendingInvitationsProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
  ...
  @$internal
  @override
  $ProviderElement<List<CrewInvitation>> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  List<CrewInvitation> create(Ref ref) {
    return pendingInvitations(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(List<CrewInvitation> value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<List<CrewInvitation>>(value),
    );
  }
}

String _$pendingInvitationsHash() =>
    r'755ea82983cd312748641ce9738e5ab45623a0dd';

/// Provider for sent crew invitations (invitations sent by current user)

@ProviderFor(sentInvitations)
const sentInvitationsProvider = SentInvitationsProvider._();
...
final class SentInvitationsProvider
    ...
    with $Provider<List<CrewInvitation>> {
  /// Provider for sent crew invitations (invitations sent by current user)
  const SentInvitationsProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
...
String _$sentInvitationsHash() => r'8ac6b8440be4032e268243ba0d6723eb699d239a';

/// Provider for invitation history (all past invitations)

@ProviderFor(invitationHistory)
const invitationHistoryProvider = InvitationHistoryProvider._();
...
final class InvitationHistoryProvider
    ...
    with $Provider<List<CrewInvitation>> {
  /// Provider for invitation history (all past invitations)
  const InvitationHistoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
...
String _$invitationHistoryHash() => r'0bfb7a436b7a69c251259fbe0f2f629372d58483';
