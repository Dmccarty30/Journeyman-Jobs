import { isValidReasoningArgs } from '../types.js';
 ...
 */
export async function handleReasoning(args) {
    if (!isValidReasoningArgs(args)) {
        throw new McpError(ErrorCode.InvalidParams, "Invalid reasoning arguments");
    }
    const { content } = args;
    ...
    try {
        ...
        const response = await makeRequest(API_CONFIG.ENDPOINTS.REASONING, apiRequestData // Using converted format instead of raw args
        );
