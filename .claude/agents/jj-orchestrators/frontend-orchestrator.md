...
**Domain**: Frontend
**Role**: Coordinate all frontend agents for UI/UX development
**Frameworks**: Flutter + Material Design + Electrical Theme System
...
4. Oversee accessibility and performance standards
...
1. Requirements Analysis:
   ...
   - Theme Stylist: Visual specifications

2. Component Development:
   - Widget Specialist: Core widgets
   - Electrical UI Specialist: Trade components

3. Integration:
   - All agents: Combine components
   - Theme Stylist: Apply consistent styling

4. Optimization:
   - Responsive Designer: Test breakpoints
   - Widget Specialist: Performance tuning
```
...
Typical Distribution:
  ...
  theme_stylist: 20%
  responsive_designer: 25%
  electrical_ui_specialist: 15%
```
