...
import '../backend/schema/conversation_model.dart';
...
void main() {
  group('ConversationModel', () {
    ...
    group('sample data scenarios', () {
      test('should handle typical conversation data', () {
        // Sample data representing typical use cases
        final testCases = [
          ConversationModel(
            id: 'user123_conv456',
          ...
          ConversationModel(
            id: '2024-01-15_14-30-00',
            name: 'Sales Call with John Doe',
          ),
        ];
        ...
        for (final testCase in testCases) {
          ...
          expect(restored.hashCode, equals(testCase.hashCode));
        }
      });

      test('should maintain equality contract with collections', () {
        // Arrange
        final model1 = ConversationModel(
          id: 'collection1',
        ...
        final set = <ConversationModel>{};
        set.add(model1);

        // Act & Assert
        expect(set.contains(model2), isTrue); // Should find equal object
        expect(set.length, equals(1));
        
        set.add(model2); // Adding equal object
        expect(set.length, equals(1)); // Should still be 1
      });

      test('should work correctly with Map keys', () {
        // Arrange
        final model1 = ConversationModel(
          id: 'mapKey1',
          name: 'Map Key Test',
        ...
        final map = <ConversationModel, String>{};
        map[model1] = 'value1';

        // Act & Assert
        expect(map[model2], equals('value1')); // Should find value with equal key
